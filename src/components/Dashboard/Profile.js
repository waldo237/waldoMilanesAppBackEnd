...
import {profileValidator, saveChanges, fetchProfile} from './profileFunctions'
    ...
    <main className={(response || displayableErrors)?'profile-container response-message': 'profile-container'}>
      ...
      ?(
        <div className='profile-card'>
          ...
          : (<div>{requestStarted ? <Loading message="Sending your changes" /> : null}{" "} </div>)}
            ...
            <button 
              ...
              onClick={()=>saveChanges({profileData, setRequest, setResponse, setErrors, pathname})}
            >Save Changes
            </button>
          </div>
          <div className='profile-serious-actions'>
            ...
            <div className="tooltip">
              <button disabled={!agreement} type='button' className='profile-cancel-btn'>Cancel Account</button>
